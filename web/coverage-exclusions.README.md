...
- `browserLifecycleHooksAndUtilities`: Viewport/browser lifecycle hooks plus scroll wrappers are thin browser side-effect surfaces. Core analytics, API, websocket, auth/proxy, store, and context utilities are not excluded.
