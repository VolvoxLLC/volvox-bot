...
export const CONFIG_CATEGORIES: ConfigCategoryMeta[] = [
  ...
  },
  {
    ...
    sectionKeys: ['moderation', 'permissions', 'auditLog'],
    featureIds: ['moderation', 'permissions', 'audit-log'],
  },
  {
    id: 'community-tools',
    icon: 'bot',
...
export const CONFIG_SEARCH_ITEMS: ConfigSearchItem[] = [
  ...
  },
  {
    ...
    keywords: ['ai automod', 'toxicity', 'spam', 'harassment', 'hate speech', 'violence'],
    isAdvanced: false,
  },
  {
    id: 'ai-automod-model',
