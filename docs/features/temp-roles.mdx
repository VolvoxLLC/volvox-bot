...
description: 'Assign temporary Discord roles that automatically expire after a set duration — ideal for giveaways, event access, trial perks, and timed permissions.'
---
