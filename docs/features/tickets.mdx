...
2. Your members click the button or use the command to open a ticket
...
<Callout type="tip">
Set up multiple categories and staff roles so the bot routes tickets to the right team automatically.
</Callout>
