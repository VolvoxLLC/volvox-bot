---
title: TL;DR
description: 'AI-powered conversation summaries — never miss what happened'
---
...
- **AI-powered** — Claude extracts key topics, decisions, action items, and links
...
1. Enable TLDR in **Config → TLDR** (disabled by default — enable it first)
...
|---------|-------------|---------|
| Enabled | Toggle the /tldr command | Off |
