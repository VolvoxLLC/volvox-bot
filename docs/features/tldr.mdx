---
title: AI-powered /tldr command for Discord channel summaries
sidebarTitle: TL;DR
description: 'The /tldr Discord command uses AI to summarize recent channel messages into key topics, decisions, action items, and notable links you may have missed.'
---
...
1. Enable TLDR in **Config → TLDR** (enabled by default)
2. Use `/tldr` in any channel to summarize recent messages
