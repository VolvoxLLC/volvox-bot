...
If you aren't a global admin, the dashboard hides these entries from the sidebar and redirects you back to the dashboard if you visit their URLs. All other dashboard features (moderation, tickets, AI, analytics, configuration) continue to follow your per-server role.
