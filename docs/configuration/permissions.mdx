---
title: Discord Permissions and Dashboard Access Control
sidebarTitle: Permissions
description: 'Understand the Discord permissions Volvox.Bot requires and how dashboard role-based access control protects server settings and member data.'
---
...
Discord roles control dashboard access. By default, anyone with **Manage Server** permission can access the dashboard for their server.
